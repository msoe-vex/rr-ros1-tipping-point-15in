...
AutonManagerNode::AutonManagerNode(NodeManager* node_manager, IDriveNode* drive_node, OdometryNode* odom_node, 
    InertialSensorNode* inertial_sensor_node, IClawNode* front_claw_node, BackClawNode* back_claw_node, ILiftNode* liftNode) : 
        ...
        m_liftNode(liftNode) {
    m_matchAuton = new MatchAuton(m_drive_node, m_odom_node, m_front_claw_node, m_back_claw_node, m_liftNode);
